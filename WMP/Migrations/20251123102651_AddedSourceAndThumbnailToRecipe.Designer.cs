...
namespace WMP.Migrations
{
    ...
    [Migration("20251123102651_AddedSourceAndThumbnailToRecipe")]
    partial class AddedSourceAndThumbnailToRecipe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMP.Models.Family", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMP.Models.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WMP.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WMP.Models.RecipeIngredient", b =>
                {
                    b.HasOne("WMP.Models.Ingredient", "Ingredient")
                        .WithMany()
